...
class Home(ssis.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        leftcolor = ssis.Label(self,height = 60,width=200, bg="wheat4")
        leftcolor.place(x=0,y=0)
        label = ssis.Label(self, text = "MSU-IIT STUDENT INFORMATION SYSTEM",bd=6,relief=RIDGE, font=("Calibre",40,"bold"),bg="tan4", fg="white smoke")
...
#________HOME FUNCTIONS________#
        def Totalcourse():
            try:
                ...
                self.totalenrolled = Label(self, font=("Arial Black", 70),textvariable = totalcourses, bg = "burlywood2", fg = "saddle brown")
                self.totalenrolled.place(x=900,y=160)
        ...
        def Totalstudents():
            try:
                ...
                self.totalenrolled = Label(self, font=("Arial Black", 70),textvariable = ttlstudents, bg = "burlywood2", fg = "saddle brown")
                self.totalenrolled.place(x=410,y=160)
...
#________WINDOW BUTTONS________#
        ...
        Button1 =ssis.Button(self, text="COURSE",font=("Palatino roman",25,"bold"),bd=10,width = 10,bg="burlywood2",fg="saddle brown",command=lambda: controller.ShowFrame(Course))
        Button1.place(x=305,y=500)
        Button2 = ssis.Button(self, text="HOME",font=("Palatino roman",25,"bold"),bd=10,width = 10,bg="burlywood2",fg="saddle brown",command=lambda: controller.ShowFrame(Home))
        Button2.place(x=565,y=500)
        Button3 =ssis.Button(self, text="STUDENTS",font=("Palatino roman",25,"bold"),bd=10, width = 10,bg="burlywood2",fg="saddle brown",command=lambda: controller.ShowFrame(Student))
        Button3.place(x=830,y=500)

        self.totalstudents=Label(self, font=("Inter Black",25,"bold"),height=5, width = 20, bd=10,text="TOTAL NO. OF STUDENTS",anchor=CENTER, bg="burlywood1",fg="saddle brown")
        self.totalstudents.place(x=210,y=200)
        
        self.totalcourse=Label(self, font=("Inter Black", 25,"bold"),height=5, width = 20, bd=10, text="TOTAL NO. OF COURSE/S",anchor=CENTER, bg="burlywood1",fg="saddle brown")
        self.totalcourse.place(x=710,y=200)
...
class Course(ssis.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        leftcolor = ssis.Label(self,height = 60,width=600, bg="wheat4")
        leftcolor.place(x=0,y=0)
        label = ssis.Label(self, text = "C O U R S E",bd=4, font=("Inter Black",40,"bold"),bg="burlywood1", fg="saddle brown")
...
#________WINDOW BUTTONS________#
        ...
        Button1 =ssis.Button(self, text="COURSE",font=("Palatino roman",25,"bold"),bd=10,width = 10,bg="burlywood1",fg="saddle brown",command=lambda: controller.ShowFrame(Course))
        Button1.place(x=265,y=550)
        Button2 = ssis.Button(self, text="HOME",font=("Palatino roman",25,"bold"),bd=10,width = 10,bg="burlywood1",fg="saddle brown",command=lambda: controller.ShowFrame(Home))
        Button2.place(x=525,y=550)
        Button3 =ssis.Button(self, text="STUDENTS",font=("Palatino roman",25,"bold"),bd=10, width = 10,bg="burlywood1",fg="saddle brown",command=lambda: controller.ShowFrame(Student))
        Button3.place(x=790,y=550)
#________LABELS AND ENTRIES________#
        
        self.lblCourseCode = Label(self, font=("Time new roman", 22, "bold"), text="COURSE CODE:", padx=5, pady=5, bg = "burlywood1", fg = "saddle brown")
        self.lblCourseCode.place(x=30,y=155)
        self.txtCourseCode = Entry(self, font=("Time new roman", 25), textvariable=Course_Code, width=12, fg = "saddle brown", bg = "burlywood1")
        self.txtCourseCode.place(x=290,y=160)

        self.lblCourseName = Label(self, font=("Time new roman", 22,"bold"), text="COURSE NAME:", padx=5, pady=5, bg = "burlywood1", fg = "saddle brown")
        self.lblCourseName.place(x=30,y=215)
        self.txtCourseName = Entry(self, font=("Time new roman", 25), textvariable=Course_Name, width=15, fg = "saddle brown", bg = "burlywood1")
        self.txtCourseName.place(x=290,y=220)

        self.SearchBarlbl = Label(self, font=("Time new roman", 18,"bold"), text="Course code:", padx=5, pady=5, bg = "burlywood1", fg = "saddle brown")
        self.SearchBarlbl.place(x=610,y=45)
        self.SearchBar = Entry(self, font=("Time new roman", 18), textvariable=SearchBar_Var,width=18, fg = "saddle brown", bg = "burlywood1" )
...
#________COURSE BUTTONS________#
        ...
        ButtonFrame=Frame(self, bd=4, bg="burlywood4", relief = GROOVE)
        ButtonFrame.place(x=40,y=300, width=500, height=170)
        
        self.btnAddID = Button(ButtonFrame, text="ADD", font=("Palatino roman", 20, "bold" ), height=1, width=10, bd=1,bg="burlywood1", fg="saddle brown",command=addCourse)
        self.btnAddID.place(x=40,y=10)
        self.btnUpdate = Button(ButtonFrame, text="UPDATE", font=("Palatino roman", 20, "bold"), height=1, width=10, bd=1,bg="burlywood1", fg="saddle brown", command=updateCourse) 
        self.btnUpdate.place(x=280,y=10)
        self.btnClear = Button(ButtonFrame, text="CLEAR", font=("Palatino roman", 20, "bold"), height=1, width=10, bd=1,bg="burlywood1", fg="saddle brown", command=clear)
        self.btnClear.place(x=40,y=90)
        self.btnDelete = Button(ButtonFrame, text="DELETE", font=("Palatino roman", 20, "bold"), height=1, width=10, bd=1,bg="burlywood1", fg="saddle brown", command=deleteCourse)
        self.btnDelete.place(x=280,y=90)
        self.btnSearch = Button(self,text= "SEARCH",font=("Palatino roman", 16,"bold"), bg = "burlywood1", fg = "saddle brown", command=searchCourse)
        self.btnSearch.place(x=1050,y=45)
        self.btnRefresh = Button(self, text="Refresh", font=('Palatino roman', 14, "bold"), height=1, width=10, bg="burlywood1", fg="saddle brown", command=Refresh)
...
class Student(ssis.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        leftcolor = ssis.Label(self,height = 60,width=600, bg="green")
        leftcolor.place(x=0,y=0)
        label = ssis.Label(self, text = "STUDENT INFORMATION",bd=4, font=("Arial Black",26,"bold"),bg="red4", fg="gold")
...
#_______LABELS AND ENTRIES_______#
        ...
        InfoFrame=Frame(self, bd=4, bg="goldenrod", relief = GROOVE)
        InfoFrame.place(x=40,y=100, width=500, height=350)

        self.lblStudentID = Label(InfoFrame, font=("Arial Black", 16,"bold"), text="ID No:", padx=5, pady=5, bg = "burlywood1", fg = "black", width = 10)
        self.lblStudentID.place(x=10,y=20)
        self.txtStudentID = Entry(InfoFrame, font=("Tmes New Roman", 16), textvariable=Student_ID, width=26, fg = "BLACK")
        self.txtStudentID.place(x=160,y=25)
        self.txtStudentID.insert(0,'YYYY-NNNN')

        self.lblStudentName = Label(InfoFrame, font=("Palatino roman", 15,"bold"), text="FULL NAME:", padx=5, pady=5, bg = "burlywood1", fg = "black",  width = 10)
        ...
        self.lblStudentCourse = Label(InfoFrame, font=("Palatino roman", 16,"bold"), text="COURSE:", padx=5, pady=5, bg = "burlywood1", fg = "black",  width = 10)
        ...
        self.lblStudentYearLevel = Label(InfoFrame, font=("Palatino roman", 15,"bold"), text="YEAR LEVEL:", padx=5, pady=5, bg = "burlywood1", fg = "black",  width = 10)
        ...
        self.lblStudentGender = Label(InfoFrame, font=("Source code", 16,"bold"), text="GENDER:", padx=5, pady=5, bg = "burlywood1", fg = "black",  width = 10)
        ...
        self.SearchBarlbl = Label(self, font=("Time new roman", 18,"bold"), text="Id Number:", padx=2, pady=2, bg = "burlywood1", fg = "saddle brown")
...
#________STUDENT BUTTONS______#
        ...
        ButtonFrame=Frame(self, bd=4, bg="goldenrod2", relief = GROOVE)
        ButtonFrame.place(x=30,y=465, width=525, height=75)

        self.btnAddID = Button(ButtonFrame, text="ADD", font=('Palatino roman', 18, "bold" ), height=1, width=7, bd=1,bg="burlywood1", fg="saddle brown",command=addData)
        self.btnAddID.place(x=7,y= 10)
        self.btnUpdate = Button(ButtonFrame, text="UPDATE", font=('Palatino roman', 18, "bold"), height=1, width=7, bd=1,bg="burlywood1", fg="saddle brown", command=updateData) 
        self.btnUpdate.place(x=264,y=10)
        self.btnClear = Button(ButtonFrame, text="CLEAR", font=('Palatino roman', 18, "bold"), height=1, width=7, bd=1,bg="burlywood1", fg="saddle brown", command=clear)
        self.btnClear.place(x=133,y=10)
        self.btnDelete = Button(ButtonFrame, text="DELETE", font=('Palatino roman', 18, "bold"), height=1, width=7, bd=1,bg="burlywood1", fg="saddle brown", command=deleteData)
        self.btnDelete.place(x=398,y=10)
        self.btnSearch = Button(self,text= "SEARCH",font=("Palatino roman", 16,"bold"), height=1, width=8, bg = "burlywood1", fg = "saddle brown", command=searchData)
        self.btnSearch.place(x=1099,y=42)
        self.btnRefresh = Button(self, text="Refresh", font=('Palatino roman', 14, "bold"), height=1, width=7, bg="burlywood1", fg="saddle brown", command=Refresh)
