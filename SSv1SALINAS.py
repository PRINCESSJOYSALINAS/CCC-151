...
# Title Label
title_label = tk.Label(root, text="STUDENT INFORMATION SYSTEM", font=("Tahoma", 35, "bold"), fg="maroon", bg="white smoke", border=10, relief=tk.GROOVE)
...
data_frame = tk.LabelFrame(root, bg="#BCC0C9", relief=tk.RIDGE, bd=5)
data_frame.place(x=610, y=80, height=610, width=700)

# Output Frames
output_area = tk.Frame(data_frame, bd=3)
output_area.place(x=25, y=310, height=280, width=622)
...
y_scrollbar.place(x=645, y=310, height=280)
myoutput.configure(yscrollcommand=y_scrollbar.set)

# Labels

name_label = tk.Label(data_frame, text="STUDENT PROFILE", font=("Times new roman", 18, "bold"), fg="maroon", bg="#BCC0C9")
name_label.place(x=250, y=10)
name_label = tk.Label(data_frame, text="Name", font=("Century",14,"bold"), fg="black", bg="#BCC0C9")
name_label.place(x=30, y=50)
id_label = tk.Label(data_frame, text="ID Number", font=("Century",14,"bold"), fg="black", bg="#BCC0C9")
id_label.place(x=380, y=50)
year_label = tk.Label(data_frame, text="Year Level", font=("Century",14,"bold"), fg="black", bg="#BCC0C9")
year_label.place(x=30, y=100)
course_label = tk.Label(data_frame, text="Course Code", font=("Century",14,"bold"), fg="black", bg="#BCC0C9")
course_label.place(x=380, y=100)
gender_label = tk.Label(data_frame, text="Gender", font=("Century",14,"bold"), fg="black", bg="#BCC0C9")
...
# Search Entry Field
search_label = tk.Label(data_frame, text="Search by Name or ID Number", font=("Arial",12, "bold"), fg="black", bg="#BCC0C9")
...
# course frame
course_frame = tk.LabelFrame(root, bg="#F5DEB3", relief=tk.RIDGE, bd=5)
...
#Course Label
courselabel = tk.Label(course_frame, text="COURSES", font=("Times new roman", 18, "bold"), fg="maroon", bg="#F5DEB3")
courselabel.place(x=225, y=15)
coursescodelabel = tk.Label(course_frame, text="Course Code:", font=("Arial",14,"bold"), fg="black", bg="#F5DEB3")
coursescodelabel.place(x=20, y=80)
coursesnamelabel = tk.Label(course_frame, text="Course Name:", font=("Arial",14,"bold"), fg="black", bg="#F5DEB3")
